...
PARAMETERS.sem_params1 = semantic_params.make_jingnet(64)

PARAMETERS.sem_params2S = PARAMETERS.sem_params2E = semantic_params.make_layer_series(64,32,32,32,16,16)
...
np.save("../results/test64_{}{}.npy".format(cat_weight, int(use_depression)), arr)
