...
PARAMETERS.sem_params1 = semantic_params.make_jingnet(16)

PARAMETERS.sem_params2S = PARAMETERS.sem_params2E = semantic_params.make_layer_series(16,16,16,16,16,16)
...
np.save("../results/test16_{}{}.npy".format(cat_weight, int(use_depression)), arr)
