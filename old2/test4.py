...
PARAMETERS.sem_params1 = semantic_params.make_jingnet(32)

PARAMETERS.sem_params2S = PARAMETERS.sem_params2E = semantic_params.make_layer_series(32,32,32,32,16,16)
...
np.save("../results/test32_{}{}.npy".format(cat_weight, int(use_depression)), arr)
