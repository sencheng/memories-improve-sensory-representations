...
if arg == 0:
    ...
    pickle.dump(sensory_system, open("../results/mininc/sensory.p", 'wb'))
...
if arg > 0:
    sensory_system = pickle.load(open("../results/mininc/sensory.p",'rb'))
    ...
    for i in range(20):
        ...
        if i == 0:
            if arg == 1:
                ...
                bsfa1.save("../results/mininc/b1.sfa")
            elif arg == 2:
                print("Training bSFA2")
                semantic.train_SFA(bsfa2, training_sequence)
                bsfa2.save("../results/mininc/b2.sfa")
        if arg == 1:
            print("Training incSFA1")
            semantic.train_SFA(incsfa1, training_sequence)
            incsfa1.save("../results/mininc/inc1_{}.sfa".format(i))
        elif arg == 2:
            print("Training incSFA2")
            semantic.train_SFA(incsfa2, training_sequence)
            incsfa2.save("../results/mininc/inc2_{}.sfa".format(i))
        np.save("../results/mininc/ran{}.npy".format(i), ran)
