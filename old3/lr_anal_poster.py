...
ad[0].set_ylabel('mean delta-value')
ad[0].set_title('slowness of 3 slowest features')

fxy =fd
axy =ad[1:]
axy[0].set_ylabel('r of latent prediction')
axy[0].set_title('correlation of features with latents')
...
# axy[0].legend((line_br, line_incr), ("batch", "incremental"), loc=1)
axy[0].legend((line_bcat, line_br), ("category", "x/y"), loc=5)
# plt.figure(fd.number)
# plt.figlegend((line_bd, line_incd, line_pred, line_xyd), ("batch", "incremental", "SFAlo", "x/y-coordinate"), 1)
ad[0].legend((line_bd, line_incd, line_pred, line_xyd), ("batch", "incremental", "SFAlo", "x/y-coordinate"), loc=5)
