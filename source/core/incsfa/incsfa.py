...
class IncSFANode(object):
    ...
    **Instance variables of interest**
    ...
    def __init__(self, input_dim, whitening_output_dim, output_dim, eps=0.001, **kwargs):
        ...
        self.eps = eps    # learning rate for mca
        self.kwargs = kwargs
...
class IncSFA2Node(IncSFANode):
    ...
    **Instance variables of interest**
    ...
    """
    def __init__(self, input_dim, whitening_output_dim, output_dim, all_expand=False, eps=0.001, **kwargs):
        ...
        if all_expand:
            whitening_output_dim = self.expnode.output_dim
